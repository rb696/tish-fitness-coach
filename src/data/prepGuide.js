export const SHOPPING_LIST = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Canola Oil', qty: '1L bottle', note: '~$4-5 · 280ml per week (20ml per meal × 14 meals)', store: 'both' },
    ],
  },
  {
...
export const COOK_GUIDES = [
  {
    ...
    steps: [
      ...
      'CANOLA OIL: 20ml per container = 140ml per cook session = 280ml total for the week',
      'Heat 15ml canola oil in a large non-stick pan over medium-high heat',
      ...
      'Cook 10-12 mins, stirring every 2 mins, until no pink remains and mince is golden',
      'Taste and adjust seasoning — don\'t under-season, it\'ll be eaten cold from the fridge',
      'Let cool 10 mins. Weigh into 7 containers of 135g cooked chicken each',
      'Add 20ml canola oil to each container — drizzle over and mix in. This is your fat macro for the meal',
      'Refrigerate up to 4 days. Repeat Wednesday.',
    ],
    tip: '💡 Raw:cooked ratio is ~4:3 (1.25kg raw → ~940g cooked). Always weigh AFTER cooking: 135g per container. Add the 20ml oil when portioning, not during cooking — it stays in the meal rather than burning off.',
  },
  {
    id: 'rice',
    emoji: '🍚',
  ...
  },
  {
    ...
    steps: [
      ...
      'No extra oil needed here — you\'re already getting 20ml canola oil in the chicken portion',
    ],
